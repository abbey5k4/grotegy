      ...
      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
        <div class="card-body">
          <p>‘’Understand your market, get organized, grow sales. From insight through execution,
              ...
              <marquee style="margin-top: 10px;" behavior="alternate" direction="left">
    ...
    <div class="card">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
        <div class="card-body">
          ...
          <marquee style="margin-top: 10px;" width = "50%" behavior="alternate" direction="left">
              <ul class="text-center">
    ...
    <div class="card">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
          <div class="card-body">
            ...
            <marquee  behavior="alternate" direction="left" style="margin-top: 10px;">
                <ul class="text-center">
                  <li><i class="far fa-lightbulb mr-2"></i>Identification</li>
                  <li><i class="fas fa-coins mr-2"></i>Market Evaluation</li>
                  <li><i class="fas fa-chess-pawn mr-2"></i>Partner evaluation</li>
